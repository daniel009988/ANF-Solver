...
#define __SZ_GAUSS__ ((__ID_SIZE__ / __SZ_ATOM__) + 1ULL) //is 79 for the large instance
...
//memory issue: 1153*4993*79 = 454.797.391
extern uint_t (*xorgauss_equivalency_history)[__ID_SIZE__][__SZ_GAUSS__]; //extern uint_t xorgauss_equivalency_history[__MAX_ANF_ID__][__ID_SIZE__][__SZ_GAUSS__]; //<--- MEMORY PROBLEM!
extern bool (*xorgauss_equivalent_history)[__ID_SIZE__]; //extern bool xorgauss_equivalent_history[__MAX_ANF_ID__][__ID_SIZE__];
extern boolean_t (*xorgauss_assignment_buffer_history)[__SIGNED_ID_SIZE__]; //extern boolean_t xorgauss_assignment_buffer_history[__MAX_ANF_ID__][__SIGNED_ID_SIZE__];
extern boolean_t xorgauss_current_degree[__ID_SIZE__];
extern boolean_t (*xorgauss_current_degree_history)[__ID_SIZE__]; //extern boolean_t xorgauss_current_degree_history[__MAX_ANF_ID__][__ID_SIZE__];
