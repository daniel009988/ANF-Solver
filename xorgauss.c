...
uint_t (*xorgauss_equivalency_history)[__ID_SIZE__][__SZ_GAUSS__]; //uint_t xorgauss_equivalency_history[__MAX_ANF_ID__][__ID_SIZE__][__SZ_GAUSS__]; //<-- MEMORY ISSUE 
bool (*xorgauss_equivalent_history)[__ID_SIZE__]; //bool xorgauss_equivalent_history[__MAX_ANF_ID__][__ID_SIZE__];
boolean_t (*xorgauss_assignment_buffer_history)[__SIGNED_ID_SIZE__]; //boolean_t xorgauss_assignment_buffer_history[__MAX_ANF_ID__][__SIGNED_ID_SIZE__];
boolean_t xorgauss_current_degree[__ID_SIZE__];
boolean_t (*xorgauss_current_degree_history)[__ID_SIZE__]; //boolean_t xorgauss_current_degree_history[__MAX_ANF_ID__][__ID_SIZE__];
