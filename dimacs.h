...
extern uint_t (*monomials_to_column)[__ID_SIZE__][__MAX_DEGREE__ - 1];
...
const int_t _dimacs_nb_of_eq(void);

int_t dimacs_count_sat(void); //count number of satisfied clauses
