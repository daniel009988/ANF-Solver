...
double wct_start;
double wct_end;
double wct_start_total;
int_t conflict_block;
int reverse;
int firstone;
int usevarmap;

int_t total_conflicts;
char varmap[10000][10]; //varmap is limited to 10000 varnames with max 10 characters
int cnfvarmap[10000]; //cnf-varmap is limited to 10000 varnames; maps to ANF varnums
int usehess;
int hess[__MAX_ID__];
